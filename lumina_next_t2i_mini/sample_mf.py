    ...
    with torch.autocast("cuda", dtype):
        for res in resolution:
            for idx, caption in tqdm(enumerate(captions)):
                ...
                print(model.n_heads)
                print(model.n_kv_heads)
                print(model.multiple_of)
                print(model.ffn_dim_multiplier)
                print(model.norm_eps)
                print(model.learn_sigma)
                print(model.qk_norm)
                print(model.cap_feat_dim)
                print(model.scale_factor)
                print(model.use_flash_attn)
                dist.barrier()
